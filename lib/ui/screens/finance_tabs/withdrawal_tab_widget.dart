...
class WithdrawalTabWidget extends StatefulWidget {
  const WithdrawalTabWidget({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _WithdrawalTabWidget();
}


class _WithdrawalTabWidget extends State<WithdrawalTabWidget> {
